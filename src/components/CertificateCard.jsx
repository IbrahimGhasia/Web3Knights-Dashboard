	...
	return (
		<div className="bg-gray-100 rounded-xl px-5 py-5 shadow-lg">
			<span className="flex items-center justify-between">
				<h4 className="text-gray-400 font-bold text-lg"> Finance</h4>
				<p className="text-gray-400 text-xs font-semibold">
					Know more {">"}
				</p>
			</span>
			<h2 className="mt-6 mb-3 text-2xl text-blue-500 font-bold">
				{props.text}{" "}
				<span className="text-green-500 ml-5">{props.number}</span>
			</h2>
